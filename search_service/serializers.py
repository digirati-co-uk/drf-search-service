...
class ContextSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            "url": {"view_name": "search_service.api.context_detail", "lookup_field": "slug"}
        }
...
class IIIFSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {"url": {"view_name": "search_service.api.iiifresource_detail"}}
...
class IndexablesSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {"url": {"view_name": "search_service.api.indexables_detail"}}
